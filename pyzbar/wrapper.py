...
"""
from ctypes import c_ubyte, c_char_p, c_int, c_uint, c_ulong, c_void_p, Structure, CFUNCTYPE, POINTER
...
zbar_version = zbar_function("zbar_version", c_int, c_uint_p, c_uint_p,)  # major,  # minor

zbar_set_verbosity = zbar_function("zbar_set_verbosity", None, c_int)

zbar_image_scanner_create = zbar_function("zbar_image_scanner_create", POINTER(zbar_image_scanner))

zbar_image_scanner_destroy = zbar_function("zbar_image_scanner_destroy", None, POINTER(zbar_image_scanner))
...
zbar_image_set_format = zbar_function("zbar_image_set_format", None, POINTER(zbar_image), c_uint)
...
zbar_scan_image = zbar_function("zbar_scan_image", c_int, POINTER(zbar_image_scanner), POINTER(zbar_image))

zbar_image_first_symbol = zbar_function("zbar_image_first_symbol", POINTER(zbar_symbol), POINTER(zbar_image))

zbar_symbol_get_data_length = zbar_function("zbar_symbol_get_data_length", c_uint, POINTER(zbar_symbol))

zbar_symbol_get_quality = zbar_function("zbar_symbol_get_quality", c_uint, POINTER(zbar_symbol))

zbar_symbol_get_data = zbar_function("zbar_symbol_get_data", c_char_p, POINTER(zbar_symbol))

zbar_symbol_get_loc_size = zbar_function("zbar_symbol_get_loc_size", c_uint, POINTER(zbar_symbol))

zbar_symbol_get_loc_x = zbar_function("zbar_symbol_get_loc_x", c_int, POINTER(zbar_symbol), c_uint)

zbar_symbol_get_loc_y = zbar_function("zbar_symbol_get_loc_y", c_int, POINTER(zbar_symbol), c_uint)

zbar_symbol_next = zbar_function("zbar_symbol_next", POINTER(zbar_symbol), POINTER(zbar_symbol))
